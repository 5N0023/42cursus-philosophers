...
/*   Updated: 2023/02/19 19:24:45 by mlektaib         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	save_arg(t_arg *param, int argc, char **argv)
{
	...
	if (ft_atoi(argv[1]) <= 0 || ft_atoi(argv[2]) <= 0 || ft_atoi(argv[3]) <= 0
		|| ft_atoi(argv[4]) <= 0 || ft_atoi(argv[1]) == 9999999999
		|| ft_atoi(argv[2]) == 9999999999 || ft_atoi(argv[3]) == 9999999999
		|| ft_atoi(argv[4]) == 9999999999)
